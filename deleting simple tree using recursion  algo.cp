...
// deleting the whole tree therefore following postorder transversal
//as if we delete root earlier we will lose access to its children
//dynamically allocated memory(using new) needs to be deleted
